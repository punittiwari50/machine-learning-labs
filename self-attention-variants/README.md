...
- `scripts/shared_text_preprocessing.py`: Shared tokenization and preprocessing helpers used by script variants.
- `scripts/basic_attention_numpy.py`: Same basic topic implemented with NumPy.
- `scripts/basic_attention_torch.py`: Same basic topic implemented with PyTorch.
- `scripts/basic_attention_tensorflow.py`: Same basic topic implemented with TensorFlow.
- `scripts/advanced_attention_numpy.py`: Advanced variant benchmarking script in NumPy.
- `scripts/advanced_attention_torch.py`: Advanced variant benchmarking script in PyTorch.
- `scripts/advanced_attention_tensorflow.py`: Advanced variant benchmarking script in TensorFlow.
- `scripts/run_attention_benchmarks.py`: Runs all basic and advanced scripts and prints a consolidated metrics table.
